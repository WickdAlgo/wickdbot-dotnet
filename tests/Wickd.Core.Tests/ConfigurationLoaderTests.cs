...
public class ConfigurationLoaderTests
{
    ...
    public void LoadResolvesConfiguredMarkets()
    {
        ...
        var settings = WickdConfigurationLoader.Load(appSettingsPath);
    ...
    public void LoadRejectsInvalidStructureSettings()
    {
        ...
        var exception = Assert.Throws<WickdConfigurationException>(() => WickdConfigurationLoader.Load(appSettingsPath));

        Assert.Contains("Wickd.Structure.MinimumSwingSeparationCandles", exception.Message);
    ...
    public void LoadRejectsInvalidDefaultTimeframe()
    {
        ...
        Assert.Contains("Wickd.Defaults.Timeframe", exception.Message);
    ...
    public void ResolveMarketRejectsUnknownMarket()
    {
        ...
        var exception = Assert.Throws<WickdConfigurationException>(() => settings.ResolveMarket("UNKNOWN_MARKET"));
