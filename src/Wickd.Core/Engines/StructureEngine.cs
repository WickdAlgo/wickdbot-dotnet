...
public sealed class StructureEngine
{
    ...
    public StructureProcessingResult Process(
    ...
    private sealed class LiquidityLevel
    {
        ...
        public int ObservedIndex { get; }

        public decimal ZoneLow { get; }

        public decimal ZoneHigh { get; }

        public string[] RelatedSwingIds { get; }
    ...
    private sealed class LiquidityBreach
    {
        ...
        public string BreachEventId { get; }
        ...
        public decimal? ProtectedSwingPrice { get; }

        internal LiquidityBreachStage Stage { get; set; } = LiquidityBreachStage.Breached;

        public int? CandidateIndex { get; set; }

        public bool IsTerminal => Stage is LiquidityBreachStage.SweepConfirmed or LiquidityBreachStage.BreakoutConfirmed;
    }
    ...
    private sealed class FvgInfo
    {
        ...
        public string OrderBlockId { get; }
    ...
    private sealed class ProcessingState
    {
        ...
        public IReadOnlyList<StructureEvent> Events => events;
