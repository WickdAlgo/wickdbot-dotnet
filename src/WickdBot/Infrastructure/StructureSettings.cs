...
/// </summary>
/// <param name="SwingFractalWindow">Number of candles required on each side of a swing candidate.</param>
...
internal sealed record StructureSettings(
    int SwingFractalWindow,
