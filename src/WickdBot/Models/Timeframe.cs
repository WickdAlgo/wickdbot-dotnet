...
/// </summary>
internal readonly record struct Timeframe
{
    ...
    /// </summary>
    internal static IReadOnlyCollection<string> SupportedValues => SupportedTimeframes.Keys.ToArray();
    ...
    internal static Timeframe Parse(string value)
    {
    ...
    internal static bool TryParse(string? value, out Timeframe timeframe)
    {
